...
public class TestClass {
   ...
   static List<String> str = new ArrayList<>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        Comparator<GuestAndRoomDto> nameComparator = (o1, o2) -> (o1.getGuest().getName().compareTo(o2.getGuest().getName()));
        List<GuestAndRoomDto> str = new ArrayList<>();
        Guest guest = new Guest();
        guest.setName("Брп");
        GuestAndRoomDto guestAndRoomDto = new GuestAndRoomDto();
        guestAndRoomDto.setGuest(guest);
        str.add(guestAndRoomDto);
        Guest guest1 = new Guest();
        guest1.setName("Амывм");
        GuestAndRoomDto guestAndRoomDto1 = new GuestAndRoomDto();
        guestAndRoomDto1.setGuest(guest1);
        str.add(guestAndRoomDto1);
        Guest guest2 = new Guest();
        guest2.setName("Ввладлы");
        GuestAndRoomDto guestAndRoomDto2 = new GuestAndRoomDto();
        guestAndRoomDto2.setGuest(guest2);
        str.add(guestAndRoomDto2);
